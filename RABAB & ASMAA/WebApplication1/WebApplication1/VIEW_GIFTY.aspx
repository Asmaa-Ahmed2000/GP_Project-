                        ...
                        <div class="DIVADD">
                         <h4 class="adds">
                                    you can add another Editor: <a href="#">
                                        <asp:LinkButton ID="adds" runat="server"><span class="fas fa-plus plus"></span></asp:LinkButton></a>
                                </h4>
             </div>
            ...
            <div class="card">
              ...
              <div class="details">
                  <h1 class="NameGIFT">
                   ...
                   <%-- <textarea id="TextArea1" cols="20" rows="2" class="earaa">--%>
                  <div class="earaa">
             ...
             <%-- <div class="footer-Deteails">
                <div class="Number">
                  <span class="fas fa-star start1"></span>
                  <span class="fas fa-star start1"></span>
                  <span class="fas fa-star start1"></span>
                  <span class="fas fa-star start1"></span>
                  <span class="fas fa-star start1"></span>
