<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeFile="Add_Editors.aspx.cs" Inherits="WebApplication1.Add_Editors" %>
...
<%--                    <input type="text" placeholder="state" class="in">--%>
                ...
                <div class=" ADMIN_PR">
                   <%-- <button>Edite Profile </button>--%>
                    <asp:Button ID="Add" runat="server" Text="Edite" OnClick="Add_Click" CssClass="Edit-admin"  />
                </div>
